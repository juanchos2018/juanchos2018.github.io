const imgAPI = {
    ...
    ponentes: [
        '/images/ponentes/pone1.png',
        '/images/ponentes/pone2.png',
        '/images/ponentes/pone3.png',
        '/images/ponentes/pone4.png',
        '/images/ponentes/pone5.png',
        '/images/ponentes/pone6.png',
        '/images/ponentes/pone7.png',
        '/images/ponentes/pone8.png',
        '/images/ponentes/pone9.png',
        '/images/ponentes/pone10.png',
        '/images/ponentes/pone11.png'
    ],
    photo: [
    ...
    sponsor: [
        ...
        '/images/sponsor/DLUKAS.png',
        '/images/sponsor/ESIS.png',
        '/images/sponsor/lococlinica.jpeg',
        '/images/sponsor/LogoRestSaborMisti.jpg',
        '/images/sponsor/LOGO LUAU FRONTERA.jpeg',
        '/images/sponsor/logo Masster_Bibcycle.png',
        '/images/sponsor/logo santafe.jpg',
        '/images/sponsor/Logo Vuce Solutions.png',
        '/images/sponsor/logo yasetec.jpg',
        '/images/sponsor/logo_Marues_Cariñoso.jpeg',
        '/images/sponsor/Logo_Mini_Market_RICHI.png',
    ...
    fashion: [
        ...
        'https://via.placeholder.com/700x360/ffd7a4/757575',
        'https://via.placeholder.com/320x370/d0d4e6/757575',
        '/images/sponsor/costasurlogo.png',
        '/images/sponsor/costasurlogo.png',
        '/images/sponsor/costasurlogo.png',
        '/images/sponsor/costasurlogo.png',
        '/images/sponsor/costasurlogo.png',
